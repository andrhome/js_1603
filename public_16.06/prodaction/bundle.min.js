...
//     var src = elem.getAttribute('data-frame'),                
//         arrSrc = src.split(','),
//         str = '';
...
window.addEventListener('DOMContentLoaded', function(){
	var newSlider = new Slider(document.querySelector('.val-slider-general-news'));
});
...
// 	var getTextWeather = function(text){
// 		var description = {
			// 0: 'Торнадо',
			// 1: 'Тропічний шторм',
			// 2: 'Ураган',
