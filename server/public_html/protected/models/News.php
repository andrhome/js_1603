...
class News extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title_ru, title_uk, description_ru, description_uk, category_id', 'required'),
			array('views, author_id, modify_by_id, marker, category_id, galery_id, main, on_index, rss', 'numerical', 'integerOnly'=>true),
			...
			array('id, marker, image, region, on_index, date, title_ru, title_uk, description_ru, description_uk, views, category_id, tags, galery_id, author, main, rss', 'safe', 'on'=>'search'),
		);
	}
